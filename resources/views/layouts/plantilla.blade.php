...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('plugins/dataTables-1.10.21/DataTables-1.10.21/css/responsive.dataTables.min.css') }}">
   ...
   {{-- dropZone para arrastrar imagen a galeria--}}
    <link rel="stylesheet" href="{{ asset('plugins/dropzone-5.7.0/dist/dropzone.css') }}">
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('plugins/dataTables-1.10.21/DataTables-1.10.21/js/dataTables.responsive.min.js')}}"></script>
...
{{-- datepicker--}}
<script type="text/javascript" src="{{ asset('plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.js')}}"></script>
<script type="text/javascript" src="{{ asset('plugins/bootstrap-datepicker/dist/locales/bootstrap-datepicker.es.min.js')}}"></script>
