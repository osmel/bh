    ...
    <div class="row">        
        ...
        {{-- precio--}}
         <div class="form-group">
            <div class="col-sm-12">
                ...
                <input type="number"  step = "any" class="form-control" name="precio" id="precio" placeholder="#.##" value="{{ old('precio') }}">
            </div>    
        </div> 
      ...
      {{-- almacen--}}
        ...
        @if ($recepcionados->isNotEmpty())
                <table id="tabla_recepcion" class="display responsive nowrap" style="width:100%">
